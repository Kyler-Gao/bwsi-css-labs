...
def request_sanitized_operation(prompt: str) -> str:
    ...
    while True:
        unsanitized_operation = input("Enter the operation (add, subtract, multiply, divide): ").strip().lower()
        if unsanitized_operation == "add" or unsanitized_operation == "subtract" or unsanitized_operation == "multiply" or unsanitized_operation == "divide":
            return unsanitized_operation
        else:
